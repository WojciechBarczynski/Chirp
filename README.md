...
As a user I want to add photos to post in order to make them more diverse. </br>
...
As a user I want to specify the level of following to make some criteria more important than others. </br>
As a user I want to block other users/tags in order not to have their content recommended. </br>
